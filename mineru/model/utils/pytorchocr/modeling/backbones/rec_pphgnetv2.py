...
class PPHGNetV2(TheseusLayer):
    ...
    Returns:
        modelv2: nn.Module. Specific PPHGNetV2 model depends on args.
    """
...
def PPHGNetV2_B0(pretrained=False, use_ssld=False, **kwargs):
    ...
    Returns:
        modelv2: nn.Module. Specific `PPHGNetV2_B0` model depends on args.
    """
    stage_config = {
...
def PPHGNetV2_B1(pretrained=False, use_ssld=False, **kwargs):
    ...
    Args:
        ...
        use_ssld (bool) Whether using ssld pretrained model when pretrained is True.
    Returns:
        modelv2: nn.Module. Specific `PPHGNetV2_B1` model depends on args.
    """
    stage_config = {
        # in_channels, mid_channels, out_channels, num_blocks, is_downsample, light_block, kernel_size, layer_num
...
def PPHGNetV2_B2(pretrained=False, use_ssld=False, **kwargs):
    ...
    Args:
        ...
        use_ssld (bool) Whether using ssld pretrained model when pretrained is True.
    Returns:
        modelv2: nn.Module. Specific `PPHGNetV2_B2` model depends on args.
    """
    stage_config = {
        # in_channels, mid_channels, out_channels, num_blocks, is_downsample, light_block, kernel_size, layer_num
...
def PPHGNetV2_B3(pretrained=False, use_ssld=False, **kwargs):
    ...
    Args:
        ...
        use_ssld (bool) Whether using ssld pretrained model when pretrained is True.
    Returns:
        modelv2: nn.Module. Specific `PPHGNetV2_B3` model depends on args.
    """
    stage_config = {
        # in_channels, mid_channels, out_channels, num_blocks, is_downsample, light_block, kernel_size, layer_num
...
def PPHGNetV2_B4(pretrained=False, use_ssld=False, det=False, text_rec=False, **kwargs):
    ...
    Args:
        ...
        use_ssld (bool) Whether using ssld pretrained model when pretrained is True.
    Returns:
        modelv2: nn.Module. Specific `PPHGNetV2_B4` model depends on args.
    """
    stage_config_rec = {
...
def PPHGNetV2_B5(pretrained=False, use_ssld=False, **kwargs):
    ...
    Args:
        ...
        use_ssld (bool) Whether using ssld pretrained model when pretrained is True.
    Returns:
        modelv2: nn.Module. Specific `PPHGNetV2_B5` model depends on args.
    """
    stage_config = {
        # in_channels, mid_channels, out_channels, num_blocks, is_downsample, light_block, kernel_size, layer_num
...
def PPHGNetV2_B6(pretrained=False, use_ssld=False, **kwargs):
    ...
    Args:
        ...
        use_ssld (bool) Whether using ssld pretrained model when pretrained is True.
    Returns:
        modelv2: nn.Module. Specific `PPHGNetV2_B6` model depends on args.
    """
    stage_config = {
        # in_channels, mid_channels, out_channels, num_blocks, is_downsample, light_block, kernel_size, layer_num
...
class PPHGNetV2_B4_Formula(nn.Module):
    ...
    Returns:
        modelv2: nn.Module. Specific `PPHGNetV2_B4` model with defined architecture.
    """
...
class PPHGNetV2_B6_Formula(nn.Module):
    ...
    Args:
        ...
        class_num (int): Number of classes for classification. Default is 1000.
    Returns:
        modelv2: nn.Module. Specific `PPHGNetV2_B6` model with defined architecture.
    """
