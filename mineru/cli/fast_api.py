...
def build_result_dict(
    ...
    for pdf_name in pdf_file_names:
        ...
        if return_content_list_v2:
            data["content_list_v2"] = get_infer_result(
...
def build_result_response(
    ...
    if response_format_zip:
        zip_path = create_result_zip(
            ...
            return_content_list_v2=return_content_list_v2,
...
def build_sync_file_parse_response(
    ...
    if task.response_format_zip:
        response = build_result_response(
            ...
            return_content_list_v2=task.return_content_list_v2,
...
""",
    ...
    return_content_list_v2: Annotated[
        bool,
        Form(description="Return content list v2 JSON in response (page-grouped format)"),
    ] = False,
...
async def run_parse_job(
    ...
    parse_kwargs = dict(
        ...
        f_dump_content_list=request_options.return_content_list or request_options.return_content_list_v2,
...
async def create_async_parse_task(
    ...
    try:
        ...
        task = AsyncParseTask(
            ...
            return_content_list_v2=request_options.return_content_list_v2,
